            ...
            children: [
              TCircularContainer(
                ...
                child: Stack(
                  children: [
                     RoundedImage(
                      isNetworkImage: true,
                      imageUrl: controller.allproduct[index]["image"][0],
                    ...
                    Positioned(
                      ...
                      child: TCircularContainer(
                        ...
                        child: Center(
                          child: Text(
                            "${controller.allproduct[index]["discount"].toString()}%" ,
                            style: TextStyle(
                      ...
                      Positioned(
                        ...
                        child: TCirculeIcon(
                          ...
                          icon:controller.favorite.contains(controller.allproduct[index])? Icons.favorite:Icons.favorite_border,
                          color: controller.favorite.contains(controller.allproduct[index])? AppColors.red:AppColors.gray,
                        )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                 ProductTitleText(title:controller.allproduct[index]["name"] ,smallSize: true,),
                   SizedBox(height: TSize.spaceBtwItems/2,),
                   TBrandTitleTextWithVerifiedIcon(title: controller.allproduct[index]["brand"], fontSize: screenWidth(33),),
                   ...
                   Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: ProductPriceText(price:controller.allproduct[index]["price"].toString(),islarge: true,),
                      ),
                      Container(
                        decoration:  BoxDecoration(
