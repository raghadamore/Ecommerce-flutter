...
class TProductCardVerticalFav extends StatelessWidget {
  const TProductCardVerticalFav({super.key, required this.index});
final int index;
  @override
            ...
            children: [
              TCircularContainer(
                ...
                child: Stack(
                  children: [
                     RoundedImage(
                      isNetworkImage: true,
                      imageUrl: controller.favorite[index]["image"][0],
                    ...
                    Positioned(
                      ...
                      child: TCircularContainer(
                        ...
                        child: Center(
                          child: Text(
                            "${controller.favorite[index]["discount"].toString()}%" ,
                            style: TextStyle(
                      ...
                      Positioned(
                        ...
                        right: 0,
                        child: TCirculeIcon(
                          onPressed:()=>controller.removefromWishList(index) ,
                          icon: Icons.favorite,
                          color:  AppColors.red,
                        )),
                  ],
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                 ProductTitleText(title:controller.favorite[index]["name"] ,smallSize: true,),
                   SizedBox(height: TSize.spaceBtwItems/2,),
                   TBrandTitleTextWithVerifiedIcon(title: controller.favorite[index]["brand"], fontSize: screenWidth(33),),
                   ...
                   Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: ProductPriceText(price:controller.favorite[index]["price"].toString(),islarge: true,),
                      ),
                      Container(
                        decoration:  BoxDecoration(
