...
class TProfileMenu extends StatelessWidget {
  const TProfileMenu({
    super.key,  this.icon=Icons.keyboard_arrow_right, required this.onPressed, required this.title, required this.value,
  });
final IconData icon;
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: 5,child: Text(value,style: Theme.of(context).textTheme.bodyMedium,overflow: TextOverflow.ellipsis,)),
             Expanded(child: Icon(icon,size: screenWidth(18),))
          ],
        ),
      ),
    );
